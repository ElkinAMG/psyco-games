  ...
  function main(timestamp) {
    ...
    try {
      ...
      if (
        ...
        noteElement.innerHTML = `Felicidades, lo conseguiste!!
          ${!hardMode ? "<p>Presiona H para el modo difícil" : ""} <br>o Presiona espacio para volver a jugar </p>`;
        noteElement.style.opacity = 1;
        gameInProgress = false;
      } else {
        previousTimestamp = timestamp;
      ...
      if (error.message == "The ball fell into a hole") {
        noteElement.innerHTML = `Un circulo rojo cayo en el hueco! Presiona espacio para volver a jugar.
          <p>
